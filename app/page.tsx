...
import { PawPrint, Calendar, Shield, Users } from 'lucide-react';
      ...
      <section className="pt-24 pb-16 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/provider" className="inline-flex items-center justify-center px-8 py-4 border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl font-medium text-lg transition-all">
              Join as a Provider
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8">
          {[
            { 
              ...
              desc: "Book in minutes. Same-day options available for urgent needs." 
            },
            { 
              icon: Shield, 
              title: "Trusted Professionals", 
              desc: "Background-checked providers with pet care expertise." 
            },
            { 
              icon: Users, 
              title: "Senior & New Owner Friendly", 
              desc: "Gentle handling and education for all pet parents." 
            }
          ].map((feature, index) => (
            <div key={index} className="p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 hover:border-emerald-200 transition-colors group">
              <div className="w-14 h-14 rounded-2xl bg-emerald-100 dark:bg-emerald-950 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
